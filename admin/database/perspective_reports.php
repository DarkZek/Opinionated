...
<div class="container">
  <h1 class="center">PERSPECTIVE REPORTS</h1>
  <table class="table">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody>
    ...
    //Get 10 reports
    //
    $query = "SELECT * FROM perspective_reports JOIN poll_perspectives ON perspective_reports.perspective_id=poll_perspectives.id WHERE perspective_reports.id BETWEEN 0 AND 10";
    ...
    function reportIDToString($id) {
      switch ($id) {
        case 1: {
          return "Its not a perspective";
        }
        case 2: {
          return "The perspective is unnecessarily offensive";
        }
        case 3: {

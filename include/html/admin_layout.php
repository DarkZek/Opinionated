...
<div class="sidebar row">
  <div class="col-2 admin-black sideselector">
  <div class="row made-by">
    <a class="white" href="https://github.com/darkzek/">Made by Marshall Ashdowne</a>
  </div>
    <div class="row white menu-item admin-menu-dashboard" onclick="document.location = '/admin/';">
      <a>Dashboard</a>
    </div>
    <div class="row white menu-item admin-menu-reports" onclick="document.location = '/admin/database/reports';">
      <a>Reports</a>
    </div>

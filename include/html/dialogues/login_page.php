...
<div class="login-page animated">
 ...
 <div class="form-group">
   <a onclick="document.location = loginWithGoogle;" type="submit" class="use-google form-control pointer"><i class="fab fa-google"></i> <div class="google-divider"></div> LOGIN WITH GOOGLE</a>
 </div>
 <br>
 <br>
